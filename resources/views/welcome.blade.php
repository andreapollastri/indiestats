            ...
            <div class="row g-4">
                @php
                    $features = [
                        ...
                        ['icon' => 'fa-bullseye', 'color' => '#8b5cf6', 'bg' => 'rgba(139,92,246,0.08)', 'title' => __('Obiettivi su eventi'), 'desc' => __('Definisci goal con indiestats.track() e monitora le conversioni.')],
