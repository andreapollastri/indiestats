...
class SiteStatsDataTablesController extends Controller
{
    public function __invoke(Request $request, Site $site, SiteStatsDataTableService $tables): JsonResponse
    {
        ...
        $validated = $request->validate([
            'type' => 'required|string|in:paths,utm,utm_source,utm_medium,utm_campaign,utm_term,utm_content,search,source,browser,device,os,country,outbound,goals,event_names,events',
