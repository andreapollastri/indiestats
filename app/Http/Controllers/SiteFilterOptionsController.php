...
class SiteFilterOptionsController extends Controller
{
    public function __invoke(Request $request, Site $site, SiteFilterOptionsService $options): JsonResponse
    {
        ...
        $validated = $request->validate([
            'type' => 'required|string|in:source,path,page_title,page_query,utm,utm_source,utm_medium,utm_campaign,utm_term,utm_content,event,device,browser,browser_version,os,language,timezone,visitor_id,is_bot,country,asn,search',
